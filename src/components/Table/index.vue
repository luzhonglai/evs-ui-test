<template>
  ...
  >
    ...
    >
      <template v-slot="scope">
        ...
        <el-button
          ...
          :style="`color: ${item.option.color}`"
          @click="handleButton(item.option.method, scope.row, index)"
          size="mini"
        >
    ...
    <el-table-column
      ...
      :min-width="tableOption.minWidth ? tableOption.minWidth : ''"
    ...
    >
      <template v-slot="scope">
        <el-button
          ...
          @click="handleButton(item.method, scope.row, index)"
          size="mini"
        >
          <ct-table-render
            v-if="item.render"
