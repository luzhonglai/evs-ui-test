...
<template>
  <div class="mt10">
    <el-pagination
      v-model:current-page="pager[props.page]"
  ...
  export default {
    ...
    setup(props: any, ctx: any) {
      ...
      const isEmptyList = computed(() => {
        return Math.ceil(props.pager[props.props.total] / props.pager[props.props.rows]) < props.pager[props.props.page]
      })
      ...
      function onChangePage(page: number) {
        ctx.emit('setPager', Object.assign(props.pager, { [props.props.page]: page }))
        ctx.emit('query', Object.assign(props.pager, { [props.props.page]: page }))
      }
